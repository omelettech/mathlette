...
https://en.wikipedia.org/wiki/Marsaglia_polar_method .</div>
							</td>
						</tr>
...
into two equal sized subsets.</div>
						...
						<tr>
							...
							<td class="nameDescription">
								...
								<div class="description">The P-th percentile ( 0 < P ≤ 100 ) of a list of N ordered values (sorted from least to greatest)
is the smallest value in the list such that no more than P percent of the data is strictly less
than the value and at least P percent of the data is less than or equal to that value.</div>
							</td>
						</tr>
...
Here, the <i>linear interpolation between closest ranks</i> method is used.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Number|Array}</span> Depending if a number or an array is the input for percentile, a number or an array containing the percentils
is returned.</dd>
