				...
				<table class="summaryTable" cellspacing="0" summary="A summary of the methods documented in the class _global_.">
					...
					<tbody>
						...
						<tr>
							<td class="attributes">&nbsp;</td>
							<td class="nameDescription">
								<div class="fixedFont"><b><a href="../symbols/_global_.html#func_sphere">func_sphere</a></b>(a, e, r)
								</div>
								<div class="description">Calculates a spherical parametric surface, which depends on az, el and r.</div>
							</td>
						</tr>
...
<!-- ============================== method details ========================= -->
				...
				<div class="sectionTitle">
					...
					<a name="func_sphere"> </a>
					<div class="fixedFont">

					<span class="light">{Array}</span>
					<b>func_sphere</b>(a, e, r)
					...
					<div class="description">
						Calculates a spherical parametric surface, which depends on az, el and r.
							...
							<br />
							<i>Defined in: </i> <a href="../symbols/src/src_3d_view3d.js.html">view3d.js</a>.
							...
							<dt class="heading">Returns:</dt>
								...
								<dd><span class="light fixedFont">{Array}</span> 3-dimensional vector in cartesian coordinates</dd>
...
<!-- ============================== footer ================================= -->
		<div class="fineprint" style="clear:both">
			...
			Documentation generated by <a href="https://www.npmjs.com/package/jsdoc-toolkit" target="_blank">JsDoc Toolkit</a> 2.4.0 on Fri Mar 08 2024 12:20:59 GMT+0100 (Mitteleuropäische Normalzeit)
		</div>
	</body>
</html>
